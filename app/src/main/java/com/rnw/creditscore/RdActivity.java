...
public class RdActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ic_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RdActivity.this, CalculatorActivity.class));
            }
        });
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                try {
                    RdActivity.this.et_m_dpsit.removeTextChangedListener(this);
                    String obj = RdActivity.this.et_m_dpsit.getText().toString();
                    if (obj != null && !obj.equals("")) {
                        if (obj.startsWith(".")) {
                            RdActivity.this.et_m_dpsit.setText("0.");
                        }
                        if (obj.startsWith("0") && !obj.startsWith("0.")) {
                            RdActivity.this.et_m_dpsit.setText("");
                        }
                        String replaceAll = RdActivity.this.et_m_dpsit.getText().toString().replaceAll(",", "");
                        if (!obj.equals("")) {
                            RdActivity.this.et_m_dpsit.setText(a(replaceAll));
                        }
                        EditText editText = RdActivity.this.et_m_dpsit;
                        editText.setSelection(editText.getText().toString().length());
                    }
                    RdActivity.this.et_m_dpsit.addTextChangedListener(this);
                } catch (Exception e) {
                    e.printStackTrace();
                    RdActivity.this.et_m_dpsit.addTextChangedListener(this);
                }
    ...
    public void reset() {
        ...
        TextView textView = this.totDeposit;
        textView.setText(getString(R.string.Rs) + "0.0");
        TextView textView2 = this.totInterest;
        textView2.setText(getString(R.string.Rs) + "0.0");
        TextView textView3 = this.maturityAmt;
        textView3.setText(getString(R.string.Rs) + "0.0");
    }
